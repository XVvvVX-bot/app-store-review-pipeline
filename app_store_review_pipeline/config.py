...
DEFAULT_APPTWEAK_REPORTS_ROOT = Path("data/reports/provider_apptweak")
DEFAULT_APPFIGURES_REPORTS_ROOT = Path("data/reports/provider_appfigures")
DEFAULT_PROVIDER_COMPARE_RAW_ROOT = Path("data/raw/provider_compare")
DEFAULT_PROVIDER_COMPARE_REPORTS_ROOT = Path("data/reports/provider_compare")
...
DEFAULT_WEB_CONNECTION_RETRIES = 3
DEFAULT_WEB_CONNECTION_RETRY_SECONDS = 15.0
DEFAULT_WEB_CONNECTION_BACKOFF_MULTIPLIER = 2.0
DEFAULT_WEB_CONNECTION_RETRY_JITTER_SECONDS = 5.0
