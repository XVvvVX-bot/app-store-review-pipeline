...
- A follow-up Amazon Shopping depth run on June 18, 2026 reached 100/100 final `200` pages and 2,000 unique web catalog reviews in 9m54s, with 0 empty pages, 0 fetch errors, 0 missing text/rating, and 1 page recovered after retry. Postgres held 2,000 distinct web catalog reviews for Amazon Shopping versus 535 RSS reviews. Page 100 requested offset 1,980, returned 20 reviews, and still had a next link, so the observed web catalog limit is still higher than 2,000 rows for this app.
